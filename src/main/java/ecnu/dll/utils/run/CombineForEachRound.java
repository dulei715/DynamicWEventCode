...
//        String extractDir = "extract_result";
    ...
    public static void combineAllRoundErrorDetails(String datasetBasicPath, String finalResultDirName, int roundSize, String roundPattern, String outputDir, String extractDir) {
//        String roundPattern = "round_%d";
//        String outputDir = "group_output";
//        String extractDir = "extract_result";
        for (int i = 1; i <= roundSize; i++) {
            ...
            String extractResultDir = StringUtil.join(ConstantValues.FILE_SPLIT, datasetPath, extractDir);
            String finalResultDir = StringUtil.join(ConstantValues.FILE_SPLIT, datasetPath, finalResultDirName);
            PostProcessUtils.combineAndExtractCombineResultErrorDetails(rawDataDir, extractResultDir);
            PostProcessUtils.furtherCombineErrorDetails(extractResultDir, finalResultDir);
        }
