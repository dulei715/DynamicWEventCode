 ...
 * 用于执行
 */
public class FixedSegmentContainingLDPBUParameterParallelRun implements Runnable {
    ...
    public FixedSegmentContainingLDPBUParameterParallelRun(String basicPath, String dataTypeFileName, Integer singleBatchSize, Double privacyBudget, Integer windowSize, File[] timeStampDataFiles, int startFileIndex, int endFileIndex, Integer segmentID, CountDownLatch latch, CountDownLatch innerLatch) {
