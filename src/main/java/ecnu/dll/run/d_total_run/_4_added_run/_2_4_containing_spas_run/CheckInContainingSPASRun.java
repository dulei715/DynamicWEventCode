package ecnu.dll.run.d_total_run._4_added_run._2_4_containing_spas_run;
...
public class CheckInContainingSPASRun {
    public static void main(String[] args) throws Exception {
        CatchSignal catchSignal = new CatchSignal();
        catchSignal.startCatch();

        String datasetPath = Constant.checkInFilePath;
        String finalResultDirName = "2.checkIn_containing_spas_result";
        ...
        // 2. 执行
        CheckInDataSetRun.runCheckInContainingSPAS();
