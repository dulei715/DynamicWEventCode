package ecnu.dll.run.a_mechanism_run.ldp_run;
...
public class _1_1_TrajectoryMechanismRun {
    /**
     * dataList 的外层List代表timestamp，内层list代表user
     */
    public static ExperimentResult runBatch(TrajectoryLDPMechanism scheme, Integer batchID, List<List<StreamDataElement<Boolean>>> batchDataList, List<StreamCountData> rawPublicationBatchList) {
