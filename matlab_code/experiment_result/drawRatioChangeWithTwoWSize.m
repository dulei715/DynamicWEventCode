function y = drawRatioChangeWithTwoWSize(input_basicPath, output_basicPath)
...
for dir_name = dataset_dirs
    ...
    outputFileName = fullfile(char(output_basicPath), 'fig', 'experiment_result', char(strcat(output_dataset_names(i),"_ratio_change_two_w_size.eps")));
    %drawBudgetChangeForSingleDatset(abs_dir, default_window_size, outputFileName);
    drawRatioChangeWithTwoWSizeForSingleDatsetExceptDynamic(abs_dir, outputFileName);
end