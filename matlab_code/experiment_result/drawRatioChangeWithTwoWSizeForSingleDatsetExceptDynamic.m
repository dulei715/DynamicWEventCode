function y = drawRatioChangeWithTwoWSizeForSingleDatsetExceptDynamic(basic_path, outputFileName)
...
for temp_name = dir_names
    ...
    [temp_ratio, temp_budget, temp_window_size] = extractRatioAndOthersFromDirName(temp_name);
    if strcmp(temp_window_size, '')
        continue;
    end
    i = i + 1;
