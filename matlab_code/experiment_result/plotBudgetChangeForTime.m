function y = plotBudgetChangeForTime(input_basicPath, output_basicPath)
...
for dir_name = dataset_dirs
    ...
    plotBasicBudgetTimeCost(abs_dir, default_window_size, metric_col_index, metric_name, metric_whether_log, shrink_ratio, outputFileName);
end