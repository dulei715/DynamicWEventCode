function y = plotWindowSizeChangeInfluenceGivenMetricForSingleDatset( ...
    basic_path, default_budget, metric_col_index, metric_name, metric_whether_log, outputFileName)
...
for temp_name = dir_names
    ...
    if metric_whether_log
        data(i,2) = log(temp_table{2,metric_col_index});
        data(i,3) = log(temp_table{3,metric_col_index});
