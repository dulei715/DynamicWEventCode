function y = drawWindowSizeChangeTimeCost(input_basicPath, output_basicPath)
...
for dir_name = dataset_dirs
    ...
    outputFileName = fullfile(char(output_basicPath), 'fig', 'experiment_result', char(strcat(output_dataset_names(i),"_window_size_change_running_time.eps")));
    drawWindowSizeChangeOnlyForTimeCostSingleDataset(abs_dir, default_budget, outputFileName);
end