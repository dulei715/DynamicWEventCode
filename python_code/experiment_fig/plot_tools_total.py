...
def plot_budget_change_for_error(input_basic_path, output_basic_path):
    dataset_dirs = [
        "1.trajectory_containing_total_result",
        "2.check_in_containing_total_result",
        "3.tlns_containing_total_result",
        "4.sin_containing_total_result",
        "5.log_containing_total_result"
    ]
