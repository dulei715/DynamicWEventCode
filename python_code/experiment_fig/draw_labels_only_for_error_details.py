...
def draw_error_containing_error_details_bar(output_basic_dir):
    # 设置绘图参数
    plt.rcParams.update({
        "text.usetex": False,
    ...
    fig, ax = plt.subplots(figsize=(13, 0.9))
...
if __name__ == '__main__':
    containing_details_error_output_basic_dir = "/Users/admin/MainFiles/5.GitTrans/3.github_file/PaperTrans/paper3_3_dynamic-Extended-W-event-DP/experiment_result_by_python/figures/experiment_result_add5"
    draw_error_containing_error_details_bar(containing_details_error_output_basic_dir)
