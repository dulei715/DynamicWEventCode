...
def plot_budget_change_influence_given_metric_for_single_dataset_containing_all(basic_path, default_window_size, metric_col_index, metric_name, metric_whether_log, shrink_ratio, output_file_name):
    ...
    plt.close()
def plot_window_size_change_influence_given_metric_for_single_dataset_containing_all(basic_path, default_budget, metric_col_index, metric_name, metric_whether_log, shrink_ratio, output_file_name):
